        ...
        <div className="bg-dark-850 p-5 rounded-xl border border-slate-800 shadow-xl space-y-4">
          ...
          <div className="space-y-1.5 pt-2 border-t border-slate-800">
            ...
            <div className="flex flex-wrap gap-1.5 text-[11px]">
              <button
                onClick={() => applyPreset('FinTech & Neobanking', 'High-frequency payment gateway suffering database deadlocks under surge transactions.')}
                className="px-2 py-1 rounded bg-dark-800 hover:bg-dark-750 text-slate-300 border border-slate-700"
              >
                💳 NeoBank Payments
              </button>
              <button
